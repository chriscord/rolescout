...
def _smartrecruiters_browser_audit(application_url: str, timeout_ms: int = 60_000) -> dict[str, Any]:
    ...
    try:
        ...
        raise RuntimeError("Playwright is not installed; install RoleNavi's browser extra") from exc

    captured: dict[str, Any] = {}
    final_url = application_url
    title = ""
    profile = Path(tempfile.gettempdir()) / "rolenavi-application-audit-browser"
    ...
    return {
        ...
        "capture_boundary": (
            ...
            "required before Next; RoleNavi did not upload a file, transmit candidate data, or "
...
def audit_application_route(posting_url: str, *, allow_browser: bool = True) -> dict[str, Any]:
    ...
    result: dict[str, Any] = {
        "schema": "rolenavi-application-route-audit-v1",
