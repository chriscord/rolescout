"""`rolescout doctor` — environment and install health check (product-spec §8).
    ...
    if choice == "codex":
        ...
        if exe:
            ...
            results.append((FAIL, "llm backend",
                            "ROLESCOUT_PROVIDER=cli but ROLESCOUT_LLM_CMD is missing "
                            "or executable was not found"))
    else:
        results.append((WARN, "llm backend",
                        "no codex CLI and no ROLESCOUT_LLM_CMD - runs use mock mode; "
