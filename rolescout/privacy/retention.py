...
def clean_runtime(project: Path | None = None, *, apply: bool = False,
    ...
    return {"schema": "rolescout-clean-manifest-v1", "dry_run": not apply,
...
def delete_person(person: str, *, apply: bool = False) -> dict:
    ...
    if apply:
        for path in candidates:
            shutil.rmtree(path)
    return {"schema": "rolescout-delete-person-manifest-v1", "person": person,
